        ...
        <div>
          <el-form :inline="true" :model="empVo"  class="demo-form-inline">
            <el-form-item label="名字:" label-width="70px">
              <el-input style="width: 300px;margin-right: 10px" prefix-icon="el-icon-search" clearable @clear="initEmp('change')"
                        placeholder="请输入员工名进行查询.." v-model="empVo.name" :disabled="showSearch"></el-input>
            </el-form-item>
            <el-form-item label="部门id:" label-width="70px">
              <el-input style="width: 130px;margin-right: 10px" prefix-icon="el-icon-search" clearable @clear="initEmp('change')"
                        v-model="empVo.departmentId" disabled></el-input>
            </el-form-item>
            <el-form-item>
            ...
            </i>高级搜索</el-button></el-form-item>
          </el-form>
        </div>
        <div>
          <el-button type="success" icon="el-icon-plus" disabled @click="showAdd(false)">添加员工</el-button>
      ...
      >
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <span :class="scope.row.minister==0?'el-tag el-tag--danger el-tag--mini el-tag--light':'el-tag el-tag--primary el-tag--mini el-tag--light'">{{scope.row.minister==0?'部长':(scope.row.gender==1?'员工':'员工')}}</span>
          </template>
        </el-table-column>
        <el-table-column
            prop="name"
...
export default {
  ...
  methods: {
    ...
    initEmp(type){
      this.empVo.departmentId = this.user.departmentI
      ...
      if(type && type == 'change'){
        ...
        if (this.empVo.departmentId){
          url +='&departmentId=' +this.empVo.departmentId;
        }
      }
