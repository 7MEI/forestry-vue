  ...
  <div>
    <el-form :inline="true" :model="historyVo"  class="demo-form-inline">
      <el-form-item label="记录人编号：" label-width="100px" prop="writeper">
        <el-input v-model="historyVo.writeper" :disabled="true" placeholder="请输入记录人编号"></el-input>
      </el-form-item>
...
<!--        <span>{{data.animals.plantname}}</span>-->
      ...
      <div>
        <div style="float: left;width: 210px;margin-bottom: 10px;margin-left: 30px">
          <img :src="data.statuspicture" class="picture-container">
        </div>
        <div style=" float: right;width: 980px;margin-right: 10px;font-family: 楷体;font-weight: 550;font-size: 23px">
          <div>
            <div style="width: 980px">
              ...
              <div style="float: left;margin-left: 70px"><p>种植地区：{{data.location}}</p></div>
              <div style="float: left;margin-left: 70px"><p>高度：{{data.height}}厘米</p></div>
              <div style="float: left;margin-left: 70px;width: 260px"><p>温度：{{data.temperature}}摄氏度</p></div>
            </div>

          </div>
          <el-divider class="fengexian"></el-divider>
          <div style="width: 100%"><p class="right-span">茎叶情况：{{data.stemleaf}}</p></div>
          <el-divider class="fengexian2"></el-divider>
          <div><p class="right-span">病虫情况：{{data.diseases}}</p></div>
          <el-divider class="fengexian2"></el-divider>
          <div><p class="right-span">生长状态：{{data.status}}</p></div>
          <el-divider class="fengexian2"></el-divider>
          <div><p class="right-span">其他：{{data.rests}}</p></div>
          <el-divider class="fengexian2"></el-divider>
