...
<div>
  <el-form :inline="true" :model="AnimalsVo"  class="demo-form-inline">
    ...
    <el-form-item style="margin-left: 10px">
      ...
      <el-button type="success" icon="el-icon-add" :disabled="quanxian" @click="toAddAnimal(false)">添加</el-button>
    </el-form-item>
  </el-form>
  <div class="left">
    <div >
    ...
    <el-card class="box-card" v-for="(animal,index) in Animals" :key="index">
      ...
      <div slot="header" class="right-right">
        ...
        <div style="float: right;margin-right: -10px">
          <el-button style=" padding: 3px 0;color: crimson;margin-top: 3px;margin-right: 7px" :disabled="quanxian" type="text" icon="el-icon-delete" @click="deleteAnimal(animal)"></el-button>
          <template>
            <el-button type="success" icon="el-icon-plus" size="mini" :disabled="quanxian" @click="toUpdateAnimal(animal,true)">修改数据信息>>></el-button>
       ...
       <div>
         <div style="float: left;width: 400px;margin-left: 160px">
  ...
  data(){
    return{
      config: {  //二维码参数
        ...
        // logo: require('../../assets/img/2.jpg'),//中间logo的地址../../assets/img/2.jpg
      },
      qrUrl:'',
      exportLink: '',
      downloadFilename: '',
